<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="Proje2_OkulKayit.KayitOl" %>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="Index.aspx">Rd1ns Label</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold"></h3>
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="ornk@gmail.com"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label class="col-form-label">Şehir</label>
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Ankara"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <center>
                        <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Kayıt Ol" OnClick="Button1_Click" /></center>
                </form>
            </div>
            <!-- //register -->
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">
                     Design by
                    <a href="https://w3layouts.com/" target="_blank">Rd1ns</a>
                </p>
                <!-- //copyright -->
                <!-- social icons -->
